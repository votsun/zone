...
export default function Iridescence({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      if (program) {
        (program.uniforms.uResolution.value as Color).r = gl.canvas.width;
        (program.uniforms.uResolution.value as Color).g = gl.canvas.height;
        (program.uniforms.uResolution.value as Color).b =
